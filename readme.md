...
veya yalnızca pozitif olup olmayacağını ve bu nedenle işaret olmadan gösterilip gösterilemeyeceğini (işaretsiz) ifade
...
deyiminde nasıl kullanacağınızı gösterir:
...
Program bir hata mesajıyla çıktı ve son println! deyimini çalıştırmadı. İndeksleme kullanarak bir öğeye erişmeye
