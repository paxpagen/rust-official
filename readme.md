...
Bu kod çalıştırıldığında x'in değeri şu şekilde yazdırılacaktır: 6. Ancak x + 1 ifadesini içeren satırın sonuna noktalı
virgül koyarak expression'dan statement'a dönüştürürsek bir hata alırız:
